...
export function Input({
  ...
  const variants = {
    ...
    minisearch:
      'bg-transparent  md:inline-block transition border-transparent -mb-px border-x-0 border-y-0 appearance-none px-0 py-1 focus:ring-transparent text-sm placeholder:text-primary',
  };
