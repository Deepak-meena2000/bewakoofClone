...
export function Footer({menu}: {menu?: EnhancedMenu}) {
  ...
  return (
    <Section
      ...
      as="footer"
      role="contentinfo"
      className={`grid min-h-[25rem] items-start grid-flow-row w-full gap-6 py-8 px-6 md:px-8 lg:px-52
    ...
    >
      ...
      <section className="grid gap-4 w-full md:max-w-[335px] md:ml-auto">
        <Heading size="lead" className="cursor-default text-primaryButton" as="h3">
          Country
        </Heading>
        <CountrySelector />
      </section>
